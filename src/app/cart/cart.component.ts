      ...
      <div class="h-screen bg-gray-100 pt-20">
        ...
        >
          <div class="rounded-lg md:w-2/3 flex flex-col">
            <div
              *ngIf="isCartEmpty()"
              class="justify-center flex items-center grow flex-col"
            >
              <h1>Cart is empty</h1>
            </div>

            <div
              *ngFor="let cart of inCartArray"
              ...
              <div class="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                ...
                >
                  ...
                  <div class="flex items-center space-x-4">
                    ...
                    <button (click)="removeItem(cart.id)">
                      <svg
          ...
          >
            ...
            <div class="flex justify-between">
              ...
              <p class="text-gray-700">{{ shipping }}</p>
              <!-- <ng-template #elseBlock class="text-gray-700"> {{shipping}}</ng-template> -->
            </div>
            <hr class="my-4" />
            <div class="flex justify-between">
...
export class CartComponent implements OnInit {
  ...
  setInitialCount(quantity: number) {
    return (this.count = signal(quantity));
  }
